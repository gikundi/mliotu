...
public class UpdateFruit extends Activity {
    ...
    private static String url = "http://10.51.4.117:8080/TestWeb/UpdateFruitClientServlet";
    ...
    private class AddManager extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(UpdateFruit.this);
        ...
        public void messageDialog(String title, String message){
            ...
            new AlertDialog.Builder(UpdateFruit.this)
                    .setTitle(title)
                    .setMessage(message)
