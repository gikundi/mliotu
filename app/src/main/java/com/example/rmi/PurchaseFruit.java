...
public class PurchaseFruit extends Activity {
    ...
    private static String url = "http://10.51.4.117:8080/TestWeb/CalFruitCostClientServlet";
    ...
    String strvid,strmodel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_purchase_fruit);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                txtmodel = (EditText) findViewById(R.id.quantity);
    ...
    private class AddManager extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(PurchaseFruit.this);
        ...
        protected String doInBackground(Void... arg0) {
            ...
            params.add(new BasicNameValuePair("name", strvid));
            // params.add(new BasicNameValuePair("username",strmake));
            params.add(new BasicNameValuePair("number",strmodel));
            ...
            if (result.equalsIgnoreCase("Success")) {
                runOnUiThread( new Runnable() {
                    public void run() {
                        ...
                        messageDialog("Success","Total price of fruits is ksh"+msg);
        ...
        public void messageDialog(String title, String message){
            ...
            new AlertDialog.Builder(PurchaseFruit.this)
                    .setTitle(title)
                    .setMessage(message)
