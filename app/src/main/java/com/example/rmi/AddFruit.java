...
import com.example.rmi.ServiceHandler;
    ...
    public class AddFruit extends Activity {
        ...
        private static String url = "http://10.51.4.117:8080/TestWeb/AddFruitClientServlet";
     ...
     /**
        ...
        private class AddManager extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog = new ProgressDialog(AddFruit.this);
            ...
            public void messageDialog(String title, String message){
                ...
                new AlertDialog.Builder(AddFruit.this)
                        .setTitle(title)
                        .setMessage(message)
